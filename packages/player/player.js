  ...
  if (submitBtn) {
    submitBtn.addEventListener('click', function () {
      ...
      var payload = {
        ...
        dose: p.dose ? p.dose.value||0 : 0, waterAmount: p.waterAmount ? p.waterAmount.value||0 : 0, ratio: p.ratio||null,
        grindSize: p.grindSize ? (p.grindSize.value||'').toString() : null, waterTemperature: p.waterTemperature ? p.waterTemperature.value||null : null,
